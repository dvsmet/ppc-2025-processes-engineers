...
Такой подход прост и надёжен для задач, где основная стоимость вычислений может быть сосредоточена в одном ранге; он подходит для текущей учебной реализации. Для больших размеров и распределённой матрицы возможна более сложная блоковая/строчно-столбцевая распределённая схема, но она выходит за рамки данной работы.
